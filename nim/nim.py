...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        old_val_est = old_q
        self.q[state, action] = old_val_est + self.alpha * (new_val_est - old_val_est)
    ...
    def choose_action(self, state, epsilon=True):
        ...
        max_q = 0
        best_action = None
        count_avail_keys = len(avail_actions)
        ...
        print(best_action)
        if epsilon:
            random_choose = random.random() < self.epsilon
            if random_choose:
                return avail_actions.pop()
            else:
                return best_action
        else:
            return best_action
